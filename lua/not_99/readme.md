...
Baseado em [Github Isquicha](https://github.com/isquicha/exercicios-logica-lua/blob/main/README.md)
...
- [x] Faça um Programa que peça um número e então mostre a mensagem O número
...
- [x] Faça um Programa que calcule a área de um quadrado, em seguida mostre o dobro
desta área para o usuário.

#### Exercicio 008

- [x] Faça um Programa que pergunte quanto você ganha por hora e o número de horas
